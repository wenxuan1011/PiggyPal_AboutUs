...
},{"process":"../node_modules/process/browser.js"}],"aboutus.js":[function(require,module,exports) {
"use strict";
...
$(".cu").hover(function () {
  ...
  $(".group_pic").css("opacity", "1"); //<<<<<<< Updated upstream:app/aboutus.js
...
$('#arrow-right').click(function () {
  delay().then(function () {
    $("#tail").css('background', "url(../img/photo/".concat(picrow[0], ".png)no-repeat center / contain"));
    $("#tail_back").css('background', "url(../img/nameCard/".concat(picrow[0], ".png)no-repeat center / contain"));

    for (var i = 0; i < 5; i++) {
      $("#".concat(namerow[i])).css("transition-duration", "0s");
      $("#".concat(namerow[i], "_back")).css("transition-duration", "0s");
    }
    ...
    for (var i = 0; i < 5; i++) {
      $("#".concat(namerow[i])).css('background', "url(../img/photo/".concat(picrow[i], ".png) no-repeat center / contain"));
      $("#".concat(namerow[i], "_back")).css('background', "url(../img/nameCard/".concat(picrow[i], ".png) no-repeat center / contain"));
      $("#".concat(namerow[i])).css("left", "".concat(picposition[i]));
      $("#".concat(namerow[i], "_back")).css("left", "".concat(picposition[i]));
      console.log("change");
...
$('#arrow-left').click(function () {
  delay().then(function () {
    $("#head").css('background', "url(../img/photo/".concat(picrow[4], ".png)no-repeat center / contain"));
    $("#head_back").css('background', "url(../img/nameCard/".concat(picrow[4], ".png)no-repeat center / contain"));
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","aboutus.js"], null)
//# sourceMappingURL=aboutus.4ae1b58a.js.map